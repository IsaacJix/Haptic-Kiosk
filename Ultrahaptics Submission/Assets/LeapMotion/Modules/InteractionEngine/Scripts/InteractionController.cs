        ...
        foreach (var contactBone in contactBones) {
          ...
          if (contactBoneCollider is SphereCollider) {
            ...
            for (int i = 0; i < numCollisions; i++) {
              ...
              /*
                            if (manager._softContacts != null)
                            {
                                print("test 1 " + manager._softContacts);
                            }
                            else
                            {
                                print("manager._softContacts == null");
                            }
                            if (manager._softContactOriginalVelocities != null)
                            {
                                print("test 2 " + manager._softContactOriginalVelocities);
                            }
                            else
                            {
                                print("manager._softContactOriginalVelocities == null");
                            }
                            if (boneCapsule != null)
                            {
                                print("test 3 " + boneCapsule);
                            }
                            else
                            {
                                print("boneCapsule == null");
                            }
                            if (_softContactColliderBuffer[i] != null)
                            {
                                print("test 4 " + _softContactColliderBuffer[i]);
                            }
                            else
                            {
                                print("_softContactColliderBuffer[" + i + "] == null");
                            }
