...
namespace Leap.Unity.Interaction {
    ...
    public class InteractionSlider : InteractionButton {
        ...
        public GameObject emoji_A;
        public GameObject emoji_S;
        public GameObject emoji_O;
        public GameObject emoji_H;
        public GameObject emoji_AS;
    ...
    private void calculateSliderValues() {
      ...
      if (horizontalSlideLimits.x != horizontalSlideLimits.y) {
        ...
        if (0.0 < _horizontalSliderPercent && _horizontalSliderPercent < 0.2)
                {
                    Debug.Log("terrible");
                    emoji_A.SetActive(true);
                    emoji_S.SetActive(false);
                    emoji_O.SetActive(false);
                    emoji_H.SetActive(false);
                    emoji_AS.SetActive(false);
                }
            else if (0.2 < _horizontalSliderPercent && _horizontalSliderPercent < 0.4)
                {
                    Debug.Log("sad");
                    emoji_S.SetActive(true);
                    emoji_A.SetActive(false);
                    emoji_O.SetActive(false);
                    emoji_H.SetActive(false);
                    emoji_AS.SetActive(false);
                }
               else if (0.4 < _horizontalSliderPercent && _horizontalSliderPercent < 0.6)
                {
                    Debug.Log("OK");
                    emoji_S.SetActive(false);
                    emoji_A.SetActive(false);
                    emoji_O.SetActive(true);
                    emoji_H.SetActive(false);
                    emoji_AS.SetActive(false);
                }
                else if (0.6 < _horizontalSliderPercent && _horizontalSliderPercent < 0.8)
                {
                    Debug.Log("Happy");
                    emoji_S.SetActive(false);
                    emoji_A.SetActive(false);
                    emoji_O.SetActive(false);
                    emoji_H.SetActive(true);
                    emoji_AS.SetActive(false);
                }
                else if (0.8 < _horizontalSliderPercent && _horizontalSliderPercent < 1.0)
                {
                    Debug.Log("AWESOME");
                    emoji_S.SetActive(false);
                    emoji_A.SetActive(false);
